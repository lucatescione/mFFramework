...
namespace mFFramework.Extensions.WindowsControls
{
    ...
    public static class ListBoxExtensions
    {
        ...
        public static int Bind<TypeSource>(this System.Windows.Forms.ListBox lbx, List<TypeSource> datasource, string propertyText, string propertyValue, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        {
            ...
            try
            {
                ...
                lbx.DisplayMember = propertyText;
                lbx.ValueMember = propertyValue;
        ...
        public static List<TypeSource> GetList<TypeSource>(this System.Windows.Forms.ListBox lbx, int index = 0)
        where TypeSource : new()
        {
            ...
            try
            {
                ...
                //if (index <= 0)
                //    typesources = lbx.Items.OfType<TypeSource>().ToList(); //.EscludiDefaultItem();
                //else
                //    typesources.Add((TypeSource)lbx.Items[index]);
                ...
                PropertyInfo propertyText = typesource.GetType().GetProperty(lbx.DisplayMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
                PropertyInfo propertyValue = typesource.GetType().GetProperty(lbx.ValueMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
        ...
        /// <returns>Il numero di elementi presenti nella ListBox</returns>
        public static int Add<TypeSource>(this System.Windows.Forms.ListBox lbx, TypeSource newItem, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
            ...
            try
            {
                ...
                lbx.Bind<TypeSource>(typesources, lbx.DisplayMember, lbx.ValueMember, order, defaultItem, thereAreItemsEmpty);
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il numero di elementi presenti nella ListBox</returns>
        public static int Add<TypeSource>(this System.Windows.Forms.ListBox lbx, List<TypeSource> newItems, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        public static int InsertAt<TypeSource>(this System.Windows.Forms.ListBox lbx, TypeSource newItem, int index, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int InsertAt<TypeSource>(this System.Windows.Forms.ListBox lbx, List<TypeSource> newItems, List<int> indexs, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int RemoveAt<TypeSource>(this System.Windows.Forms.ListBox lbx, int index, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int RemoveAt<TypeSource>(this System.Windows.Forms.ListBox lbx, List<int> indexs, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int Remove<TypeSource>(this System.Windows.Forms.ListBox lbx, TypeSource removeItem, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int Remove<TypeSource>(this System.Windows.Forms.ListBox lbx, List<TypeSource> removeItems, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int ReplaceAt<TypeSource>(this System.Windows.Forms.ListBox lbx, TypeSource replaceItem, int index, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        /// <param name="thereAreItemsEmpty">Indica se considerare gli elementi vuoti</param>
        /// <returns>Il number di elementi presenti nella ListBox</returns>
        public static int ReplaceAt<TypeSource>(this System.Windows.Forms.ListBox lbx, List<TypeSource> replaceItems, List<int> indexs, Order order = Order.None, string defaultItem = null, bool thereAreItemsEmpty = true)
        where TypeSource : new()
        {
        ...
        public static TypeSource GetItem<TypeSource>(this System.Windows.Forms.ListBox lbx, int index)
        where TypeSource : new()
        {
        ...
        public static List<TypeSource> GetItem<TypeSource>(this System.Windows.Forms.ListBox lbx, List<int> indexs)
        where TypeSource : new()
        {
        ...
        /// <returns>L'elemento recuperato</returns>
        public static TypeSource GetItem<TypeSource>(this System.Windows.Forms.ListBox lbx, string item, ItemBoundedProperty typeItem = ItemBoundedProperty.Text)
        where TypeSource : new()
        {
            ...
            try
            {
                ...
                return (typeItem == ItemBoundedProperty.Text)
                        ? lbx.GetList<TypeSource>().Find(typesource => typesource.GetType().GetProperty(lbx.DisplayMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase).GetValue(typesource, null).ToString().Trim() == item.Trim())
                        : lbx.GetList<TypeSource>().Find(typesource => typesource.GetType().GetProperty(lbx.ValueMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase).GetValue(typesource, null).ToString().Trim() == item.Trim());
        ...
        public static List<TypeSource> GetItem<TypeSource>(this System.Windows.Forms.ListBox lbx, List<string> items, ItemBoundedProperty typeItem = ItemBoundedProperty.Text)
        where TypeSource : new()
        {
                    ...
                    if (!string.IsNullOrEmpty(proprieta))
                    {
                        ...
                        if (typeItem == ItemBoundedProperty.Text)
                            typesources.AddRange(
                                alltypesources.Where(item => item.GetType().GetProperty(lbx.DisplayMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase).GetValue(item, null).ToString().Trim() == proprieta.Trim()).ToList()
                                );
                        else
                            typesources.AddRange(
                                 alltypesources.Where(item => item.GetType().GetProperty(lbx.ValueMember, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase).GetValue(item, null).ToString().Trim() == proprieta.Trim()).ToList()
                                 );
                    }
                });
        ...
        public static Dictionary<string, string> GetDictionary(this System.Windows.Forms.ListBox lbx)
        {
            try
            {
        ...
        public static TypeSource GetSelectedItem<TypeSource>(this System.Windows.Forms.ListBox lbx)
        where TypeSource : new()
        {
            ...
            try
            {
                ...
                if (lbx.SelectionMode == SelectionMode.MultiSimple)
                {

                    Logger.Istance.Write(Assembly.GetExecutingAssembly(), MethodBase.GetCurrentMethod(), new Exception("lbx.SelectionMode == SelectionMode.Multiple"), TypeError.Managed);
                    return default(TypeSource);
                }
        ...
        /// <param name="lbx">ListBox dalla quale recuperare l'elemento selezionato</param>
        /// <returns>L'elemento selezionato</returns>
        public static List<TypeSource> GetSelectedItems<TypeSource>(this System.Windows.Forms.ListBox lbx)
        where TypeSource : new()
        {
            ...
            try
            {
                ...
                if (lbx.SelectionMode == SelectionMode.One)
                {

                    Logger.Istance.Write(Assembly.GetExecutingAssembly(), MethodBase.GetCurrentMethod(), new Exception("lbx.SelectionMode == SelectionMode.Single"), TypeError.Managed);
                    return default(List<TypeSource>);
                }
        ...
        /// <returns>L'elemento selezionato</returns>
        public static TypeSource SetSelectedItem<TypeSource>(this System.Windows.Forms.ListBox lbx, string item, ItemBoundedProperty typeItem = ItemBoundedProperty.Text)
        where TypeSource : new()
        {
        ...
        /// <returns>L'elemento selezionato</returns>
        public static List<TypeSource> SetSelectedItem<TypeSource>(this System.Windows.Forms.ListBox lbx, List<string> items, ItemBoundedProperty typeItem = ItemBoundedProperty.Text)
        where TypeSource : new()
        {
